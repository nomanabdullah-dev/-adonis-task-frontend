      ...
      <div class="flex flex-row flex-wrap items-center justify-between">
        ...
        <div class="w-full md:w-1/2">
          ...
          <div class="mx-auto text-center" v-else>
            <img src="/img/box.png" class="mx-auto mt-6 object-scale-down h-20 w-full">
        ...
        <div class="w-full md:w-1/2 mt-20">
          <form @submit.prevent="createTask" class="bg-white rounded px-8 py-4 shadow hover:shadow-md">
            ...
            <div class="mt-12">
              <input type="text" v-model="form.task" class="shadow border rounded w-full py-3 px-3 text-gray-700 focus:outline-none" placeholder="Enter Task">
            </div>
